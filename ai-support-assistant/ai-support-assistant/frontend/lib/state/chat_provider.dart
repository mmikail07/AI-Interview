...
/// Owns the transcript and the conversation id, and brokers calls to the API.
/// Chosen state solution: `provider` (ChangeNotifier) — lightweight and the
/// idiomatic default for an app this size.
class ChatProvider extends ChangeNotifier {
  ...
  Future<void> send(String text) async {
    ...
    try {
      ...
      // Graceful UI fallback — never leave the user staring at a frozen send.
